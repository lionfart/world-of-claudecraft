...
export const COMMAND_NAMES = [
  ...
  'territory_harvest',
  // Preserve the fork's existing command ordering, then append v0.42.1's new
  // protocol tokens. Wire command names are append-only.
  'perfect_item',
  'material_separate',
  'material_combine',
...
export const DISPATCH_ONLY_COMMANDS = [
  ...
  'rift_enchant_item',
  // The retired Proving Shore tutorial command remains an append-only wire
  // tombstone; no current ClientWorld surface emits it.
  'tutorial_start',
...
export const COMMAND_FACETS = {
  ...
  // IWorldFarming: plot mutations. Static patch and plot reads have no command.
