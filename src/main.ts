    ...
    requestAnimationFrame(() => {
      ...
      const revealWorld = (): void => {
        ...
        window.setTimeout(() => {
          ...
          // finishes in parallel. Secondary WebGL previews are owned by the
          // paced startPostEntryPreviewPrewarm lane above, which yields to the
          // player's first input through its idle-slot and headroom checks.
