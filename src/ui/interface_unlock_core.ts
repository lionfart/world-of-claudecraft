...
export const HUD_FRAME_SPECS: readonly HudFrameSpec[] = [
  ...
  // The Donate reminder chip (#community-hud), movable like any other corner
  // chrome so a player can park it out of the way. The stable internal id keeps
  // existing player layout saves compatible after the Steam reminder removal.
