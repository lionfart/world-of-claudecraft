...
const ITEM_ENTITY_IDS = [
  ...
  'mother_of_pearl',
  'ps_passing_stone',
  // Operator-fork Territory War siege items.
  'territory_wood',
  'territory_iron',
  'territory_grain',
  'territory_labor',
...
const APPENDED_ITEM_NAMES: Partial<Record<ItemEntityId, string>> = {
  ...
  territory_wood: 'Territory Timber',
  territory_iron: 'Territory Iron',
  territory_grain: 'Territory Grain',
  territory_labor: 'Labor Contract',
  territory_battering_ram: 'Battering Ram',
  territory_field_mortar: 'Field Mortar',
  territory_catapult: 'Field Catapult',
