...
export const hudChromeStrings = {
  ...
  death: {
    ...
    spiritHealerAlive:
      "The Pale Keeper watches over the dead. You are still among the living.",
  ...
  unstuck: {
    ...
    noSafePosition:
      "No reachable safe spot was found nearby. You were not moved.",
  ...
  dailyRewards: {
    ...
    walletConnectBody:
      "Verify a Solana wallet with WOC to unlock daily rewards.",
    walletConnectButton: "Verify Wallet",
    walletHoldTitle: "Hold WOC",
    walletHoldBody:
      "Hold at least {amount} USD in WOC to unlock daily rewards.",
    walletPriceBody:
      "WOC pricing is unavailable right now. Check back shortly.",
    reason: {
      ...
      price_unavailable:
        "WOC price is unavailable, rewards are temporarily locked.",
  ...
  trade: {
    ...
    woc: {
      ...
      blockRecipientNoWallet:
        "That player must connect a wallet to accept $WOC payments.",
      ...
      hintClearYourItems:
        "Remove your own items: a $WOC offer buys what they are selling.",
      hintAwaitTheirItems:
        "Waiting for them to offer something that can be sold for $WOC.",
      ...
      hintGoldOffered:
        "Remove your gold offer first: a trade is gold or $WOC, not both.",
      ...
      settled:
        "Paid. Your item is in your bags, or arrives by Ravenpost mail if they were full.",
      ...
      hintInsufficientBalance:
        "That is more $WOC than your connected wallet holds.",
      ...
      closedCancelled:
        "This sale was cancelled. The item returns to the seller by Ravenpost mail.",
      closedSuspended:
      ...
      p2pPaymentDueAt:
        "Payment is due by {time}. Not paying earns a Marketplace strike.",
      // The lapsed staged quote, in this arm's words: there is no request
      // control here, the way back is Not now, then Pay.
      quoteExpiredTrade:
        "The quote expired. Press Not now, then Pay again for a fresh one.",
      ...
      quoteStaged:
        "Payment quote ready for {usd}: {tokens} $WOC, valid until {time}.",
  ...
  wocStore: {
    ...
    wallet: {
      ...
      linkedConnected:
        "Your linked wallet app is connected and ready for SOL or WOC purchases.",
      mismatched:
    ...
    charter: {
      ...
      granted:
        "The charter was applied. The bank of this character is larger now.",
      alreadyGranted:
        "This charter is already on this character. You were not charged again.",
      applyDeferred:
      ...
      doesNotFit:
        "The bank of this character cannot fit the full grant of this charter.",
  ...
  claudium: {
    ...
    checkoutPending:
      "Transaction in progress. Confirm in your wallet and keep this panel open.",
    ...
    checkoutWalletRequired:
      "Connect a Solana wallet before buying Claudium with crypto.",
    checkoutWalletUnsupported:
      "This wallet cannot sign and send Solana transactions.",
    checkoutNotSettled:
  ...
  paladin: {
    ...
    devotionAscensionCharges:
      "Devotion {value} of {max}. Ascension {charges} charges.",
    devotionAscensionLast: "Devotion {value} of {max}. Ascension final charge.",
    ascensionLastAnnouncement: "Ascension final charge",
    ascensionSpenderAria:
      "Action slot {slot}: {ability}. Consumes one Ascension charge.",
  },
  ...
  mobile: {
    ...
    stanceAnchorAria:
      "Stance: {stance}. Tap to open the stance ring, then pick another stance.",
    stanceAnchorEmptyAria:
      "No stance. Tap to open the stance ring, then pick a stance.",
    ...
    questStripAria:
      "Tracked quest {position} of {total}: {title}. Activate for the next quest.",
  ...
  tutorial: {
    ...
    nextTipQuestLog:
      "Open your Quest Log ({key}) to find your next task nearby.",
  ...
  bootcamp: {
    ...
    coachReadyBodyTouch:
      "Head to {npc} and tap them to hand it in and take your reward.",
    coachReadyBodyPad:
    ...
    taskPouchBodyTouch:
      "Tap {npc} to open the stall, then tap the Linen Pouch to buy it.",
    taskPouchBodyPad:
    ...
    voiceFirstFlag:
      "That is one flag down. Keep those legs moving, only two to go.",
    voiceRunDone:
      "A clean run, that. Overseer Pell holds your reward, go claim it.",
    voiceStationDoneA:
      "Fine work. On to the next, the path is already lit for you.",
    voiceStationDoneB: "You are getting the hang of this, no mistake.",
    voiceVeerOff:
      "Hold up, friend, that is the wrong way. The golden path is behind you.",
    voiceGraduate:
  ...
  actionBar: {
    ...
    editKeysHint:
      "Click a slot on the action bar, then press a key to bind it.",
    bannerHint:
      "Click a slot, then press a key to bind it. Click Done when finished.",
    ...
    conflictBody:
      "{key} is already bound to {other}. Binding it to {action} will unbind {other}.",
  ...
  mounts: {
    ...
    emptyDropHint:
      "Rarer mounts drop from heroic dungeon bosses and Rift completions.",
    ...
    desc_valorsteed:
      "A hardy, sure-footed steed that provides enhanced travel speed.",
    desc_grag_bear:
      "A hardy, sure-footed bear that provides enhanced travel speed.",
    desc_stalkglider_snail:
      "A hearty, slow-burning snail that provides enhanced travel speed.",
  ...
  mountTraining: {
    ...
    ridePrompt:
      "Follow the glowing marker to the start line, then press Start Race.",
    begin: "Begin Lesson",
    success: "You have tamed the Valorsteed.",
    returnToMarla:
      "Return to Marla at the stables to buy your Valorsteed reins for 10g.",
  },
  ...
  bg: {
    ...
    offlineNote:
      "Thornhollow Fields is syncing. The queue opens once the realm answers.",
    ...
    boardToggleLabel:
      "Match scoreboard. Press Enter to pin the full board open.",
    levelRequirement:
      "You must reach level {level} to unlock queueing for this battleground.",
    board: {
      kills: "Kills",
      assists: "Assists",
      deaths: "Deaths",
    ...
    capturedTeamBanner:
      "The {takers} have captured the {team} flag! {crimson}:{azure}",
    ...
    victoryBanner:
      "Victory! Thornhollow Fields {crimson}:{azure}. Rating {rating} ({delta})",
    defeatBanner:
      "Defeat. Thornhollow Fields {crimson}:{azure}. Rating {rating} ({delta})",
    drawBanner:
      "Thornhollow Fields draw {crimson}:{azure}. Rating {rating} ({delta})",
    // The verdict banner's first secondary line: the score and the rating swing.
    endBannerDetail:
      "Thornhollow Fields {crimson}:{azure}. Rating {rating} ({delta})",
    endLog:
      "Thornhollow Fields ended {crimson}:{azure}. Rating {rating} ({delta}).",
  ...
  options: {
    ...
    graphicsSaved:
      "Graphics settings saved. The active renderer already matches them.",
    graphicsFailed:
      "Graphics could not be applied. Your previous settings are still active.",
  ...
  controller: {
    ...
    crossHotbarCarrying:
      "Carrying {action}: confirm on a cell to place it, cancel to put it back.",
    crossHotbarEditHint:
  ...
  perf: {
    ...
    description:
      "Choose which stats to show, where the overlay sits, and how it looks.",
    ...
    diagnostics: {
      ...
      status: {
        ...
        waitingFrames:
          "Waiting for representative gameplay frames: {current}/{minimum}",
        collectingNow:
          "Collecting active gameplay: move through the problem area now.",
      ...
      metrics: {
        ...
        render:
          "render  submit {submit} ms | world {world} ms | entities {entities} ms",
        scene: "scene   {calls} calls | {triangles} tris | {views} views",
        hitches:
          "hitches {hitches} | shaders {shaders} | uploads {uploads} | views {views}",
        hitchesBuild:
          "zone builds {zoneBuilds} | off-frame {offFrame} | gc {gc}",
        gpu: "GPU     {renderer}",
      ...
      diagnosis: {
        ...
        titles: {
          ...
          offFrameHitch:
            "Long frames come from work outside the render callback",
        ...
        evidence: {
          environment:
            "The environment rule {rule} matched this device and browser.",
          gpuSubmit:
            "WebGL submission p95 is {submit}, or {share} of renderer p95.",
          frame: "The recent window measured {fps} FPS with a {p95} frame p95.",
          sceneCalls:
            "The scene uses {calls} draw calls against a target of {target}.",
          sceneTriangles:
            "The scene submits {triangles} triangles against a target of {target}.",
          sceneCategory:
            "Scene category {category} contributes {calls} calls and {triangles} measured triangles.",
          censusNeeded:
            "Refresh the scene census to identify the leading render category.",
          shadow:
          ...
          assets:
            "The preload gate waited {wait} for {tasks} registered tasks.",
          failedAssets: "Failed asset groups: {groups}.",
          longTasks:
            "{count} long tasks were measured, with p95 {p95} and maximum {max}.",
          network:
            "Snapshot interval is {interval}, latest age is {age}, and input echo p95 is {echo}.",
          snapshot:
            "Snapshot parse and apply p95 is {work}; network gap p95 is {gap}.",
        ...
        tryNow: {
          ...
          graphics:
            "Retest the same camera path on Low graphics to confirm graphics pressure.",
          cpu: "Repeat the scan while idle and while moving to isolate the CPU phase.",
          loading:
            "Repeat the same route or first-use action to confirm when the hitch occurs.",
          network:
            "Compare Play Offline with the same movement and camera path.",
        },
        codeFix: {
          environment:
  ...
  auraOverlay: {
    ...
    previewHint:
      "Use Setup Positions to move an aura without covering the menu.",
  ...
  warfareShop: {
    ...
    buyConfirmBody:
      "Buy {item} for {honor}? Honor purchases cannot be refunded.",
  },
  ...
  statInfo: {
    ...
    desc: {
      ...
      attackPower:
        "Powers your weapon attacks. Every 14 attack power adds 1 damage per second.",
      spellPower:
      ...
      critChance:
        "Your chance for an attack to strike critically, dealing double damage.",
      dodge:
        "Your chance to completely avoid an incoming melee attack, taking no damage.",
      critRating:
    ...
    effects: {
      ...
      damageReduction:
        "Damage reduction against a level {level} attacker: {value}%",
    ...
    notes: {
      ...
      dpsApprox:
        "An estimate, it excludes critical strikes and ability damage.",
    },
  ...
  itemProc: {
    ...
    attackSlow:
      "and slows the target attack speed by {pct}% for {duration} sec",
  ...
  plurals: {
    ...
    reliquaryCellOwnedClearsObtainedAria: {
      ...
      other:
        "{name}, catalogued, first found on clear {clears}, obtained {count} times",
    },
    deedsRetroSummary: {
  ...
  bugReport: {
    ...
    submittedNoShot:
      "Bug report sent, but the screenshot was too large to include.",
    describeFirst: "Please describe the bug before sending.",
    tooLarge:
      "That report is too large to send. Try again without the screenshot.",
    rateLimited:
      "You've sent several reports recently. Please wait a bit before sending another.",
  ...
  account: {
    ...
    passwordSet:
      "Password set. You can now sign in with your username and password anywhere.",
    // Email
    emailLabel: "Email (optional)",
    emailHint:
      "Used only for account recovery. Use Change Email below to update it.",
    ...
    deactivatedLocked:
      "This account has been deactivated. Contact an admin to restore it.",
    // Characters
    ...
    // Wallet
    walletSummary:
      "Verify a Solana wallet to show holder flair on your player card.",
    ...
    changeEmailSent:
      "Check your inbox: open the link we sent to confirm your new email.",
    ...
    errTwoFactorState:
      "Two-factor setup is not in the expected state. Reload and try again.",
    // Data export (GDPR)
  ...
  masterLoot: {
    ...
    summaryMaster:
      "Loot Settings: Master Loot, Master Looter {name}, threshold {threshold}.",
  ...
  corpseHarvest: {
    ...
    nothingSelectedYields:
      "Nothing you selected can be harvested from this corpse.",
  ...
  bags: {
    ...
    reorderNeedsRecent:
      "Clear the filter and sort by Recent to rearrange your bags",
  ...
  varkhulCallout: {
    leftPillarCharging:
      "The left forge pillar is charging. It will ignite in 3 sec!",
    rightPillarCharging:
      "The right forge pillar is charging. It will ignite in 3 sec!",
    bothPillarsCharging:
      "The forge pillars are charging. They will ignite in 3 sec!",
  ...
  raidBossGuide: {
    ...
    ignivar: {
      ...
      rainResponse:
        "Move into an unmarked gap and leave every meteor circle before impact.",
      ...
      apocalypse:
        "Apocalypse: kill Ignivar Ashcaller before its cast completes.",
      judgment:
    ...
    varkhul: {
      ...
      anvilResponse:
        "Group for raid healing and use defensive cooldowns for the final strike.",
      anvilHeroicResponse:
      ...
      tanks:
        "Tanks: swap at two stacks of Maker's Brand and keep Varkhul in melee range.",
  ...
  auraEffect: {
    ...
    mendingCurrent:
      "Stores {value} healing, released over time or consumed by Cascading Mend",
    mendingCurrentPercent:
      "Stores healing equal to {pct}% of maximum health for Cascading Mend",
    ...
    cooldownCap:
      "{used} of {cap} sec of cooldown reduction used in this window",
    funeralHarvestLock:
      "Funeral Harvest cannot create another Soul Fragment yet",
    leadenHexLock: "Leaden Hex cannot root this target again yet",
    forbiddenReflectionReady:
      "Your next eligible Warlock cooldown can be cast again",
    forbiddenReflectionLock:
      "Forbidden Reflection cannot be prepared again yet",
    internalCooldown:
      "This effect cannot trigger again until the timer expires",
    ...
    carriedFlag:
      "You are carrying the enemy flag. Cancel this buff to drop it.",
    ...
    reckless:
      "Increases critical strike chance by {pct}% and Rage generation by {ragePct}%",
    ...
    sanguine:
      "Increases attack speed by {hastePct}% and damage dealt by {dmgPct}%",
    ...
    suddenDeath:
      "Your next Execute costs no Rage and ignores its health requirement",
    aoeEcho:
      "{charges} echoes remain: single-target abilities deal {pct}% damage to up to {targets} nearby enemies",
    sureCrit:
      "{charges} damaging ability casts are guaranteed critical strikes",
    temporalEcho:
    ...
    overloadNext:
      "Your next spell is amplified by {pct}% but costs 50% more mana",
    powerEchoNext:
      "Your next direct spell repeats at {pct}% power on the same target",
    iceFloesCasts:
      "Your next {n} spells with a cast time can be cast while moving",
    ...
    resourceSap:
      "Restores {value} of your current resource every {interval} sec",
    ...
    guardianWard:
      "The next lethal enemy hit restores you to {pct}% health instead",
    ...
    sourceVuln:
      "Takes {pct}% more damage from the caster who applied this effect",
    ...
    formLich:
      "Soul Lance also strikes up to {targets} nearby enemies for {pct}% damage",
    afflictionEye:
    ...
    afflictionPossession:
      "Empowers Needle of Fate, Consume, Maledict Gaze, and Sentence",
    afflictionJudgment:
    ...
    warlockAnchor:
      "Recast within {range} yd to return here and consume the anchor",
    formMetamorph:
      "Demon form: body size increased by {pct}%; other bonuses ride separate buffs",
    ...
    overpowerCharge:
      "{stacks} charges: your next Maiming Strike deals {pct}% more damage",
    sweepingStrikes:
      "Single-target strikes also hit {targets} nearby enemy for {pct}% damage",
    fingersOfFrost:
    ...
    wintersChill:
      "{charges} charges: compatible spells treat this target as frozen",
  ...
  auth: {
    ...
    appleChoiceIntro:
      "Create a new account, or link Apple to one you already have.",
    appleChoiceExpired:
      "That Apple sign-in expired. Please sign in with Apple again.",
    forgotPrompt: "Forgot password?",
    forgotTitle: "Reset your password",
    forgotHint:
      "Enter your username and we will email a reset link to the address on file.",
  ...
  materialHint: {
    ...
    arcaneDust:
      "Enchanting reagent. Disenchanted from common and uncommon gear.",
    arcaneEssence: "Enchanting reagent. Disenchanted from rare gear.",
    arcaneShard:
      "Enchanting reagent. Disenchanted from epic and legendary gear.",
    resonantThread:
      "Enchanting reagent. Disenchanted from rare and better cloth armor.",
    resonantHide:
      "Enchanting reagent. Disenchanted from rare and better leather armor.",
    resonantLinks:
      "Enchanting reagent. Disenchanted from rare and better mail armor.",
    resonantSteel:
      "Enchanting reagent. Disenchanted from rare and better melee weapons.",
    resonantTimber:
  ...
  discord: {
    ...
    choice: {
      ...
      intro:
        "Create a new account, or link your Discord to one you already have.",
      ...
      expired:
        "That Discord sign-in expired. Please sign in with Discord again.",
    },
  ...
  steam: {
    ...
    noTicket:
      "Steam did not provide a link ticket. Start Steam, then try again.",
  ...
  epic: {
    ...
    noProof:
      "Epic did not provide a link proof. Launch from the Epic Games Store, then try again.",
  },
  ...
  mailbox: {
    ...
    indicatorTip:
      "You have {count} unread letters. Visit a mailbox to read them.",
  ...
  bank: {
    ...
    vaultDepositAllFull:
      "Materials deposited: {count}. Some ceilings are full.",
    ...
    guildOpenConfirm:
      "Open the guild bank for {price}? This is paid from your own money.",
    ...
    guildDormantNote:
      "Locked items cannot be withdrawn and prevent disbanding the guild.",
    guildDormantHint:
      "This item is locked in the guild bank and cannot be withdrawn.",
  ...
  social: {
    ...
    billboard: {
      ...
      result: {
        ...
        notOfficer:
          "Only officers and the Guild Master may edit the billboard.",
      },
    },
  },
  ...
  gathering: {
    ...
    toolTierUnmet: {
      ...
      herbalism:
        "You need a tier {tier} herbalism sickle to gather this patch.",
    ...
    wieldUnmet: {
      ...
      logging:
        "You need Logging {skill} to swing the axe already in your bags.",
      herbalism:
        "You need Herbalism {skill} to work the sickle already in your bags.",
    },
    // The corpse flavor of the wield arm: profession-neutral like its
    // tier-based sibling below.
    wieldUnmetCorpse:
      "You need gathering skill {skill} to put your finest tool to work.",
    ...
    toolTierUnmetCorpse:
      "You need a tier {tier} gathering tool to recover the finest materials.",
    ...
    toolTooltip: {
      ...
      rodBand:
        "Unlocks richer catch tables at fishing skill {skill} and above.",
    },
    ...
    downgradeMark:
      "Bags full: the find was stored without its gatherer's mark.",
  ...
  professions: {
    ...
    toolEffectTooltip: {
      ...
      charges:
        "Starts with {base} charges on a common tool (+{bonus} per rarity rung).",
    ...
    toolEffectRechargeToolCapped:
      "Carry a better {profession} tool to charge {effect} further.",
    toolEffectRechargeMaterials:
      "Recharging {effect} needs {material} x{count}.",
    ...
    disenchantingProgress:
      "You are disenchanting: {remaining}s of {total}s remaining.",
    enchantingProgress:
      "You are enchanting: {remaining}s of {total}s remaining.",
    ...
    nextUnlockSpecialized:
      "{points} points to Specialized: material costs drop",
    ...
    tutorialLine:
      "Reach {target} skill in any craft to unlock your first tier.",
    ctaHeader: "Next step",
  ...
  crafting: {
    ...
    createAllAria:
      "Create the maximum number of this recipe from materials held",
    ...
    learnMoreAtStation:
      "{master} at the {station} can teach you more {craft} recipes.",
    ...
    commissionToggleHint:
      "Binds to the first character to receive it in a trade.",
  ...
  unbind: {
    ...
    intro:
      "The master can release a commission piece from its bond, for a fee.",
  ...
  commissionBoard: {
    ...
    intro:
      "Commission a crafter to make you a piece, or take on someone else's order.",
    ...
    denyNotEligibleCrafter:
      "That commission order was posted for someone else.",
    ...
    denyNotCrafted:
      "Craft the commissioned piece first (with the commission toggle on).",
  ...
  reliquary: {
    ...
    illuminationBroadcastLine:
      "{name} has illuminated a Reliquary page: {page}",
    ...
    accountScopeNote:
      "Account collection: unlocked across every character on this account.",
    ...
    gridKeyboardHint:
      "Use the arrow keys to move between relics, Home and End for the ends.",
    filterAll: "All",
  ...
  deeds: {
    ...
    lbSelfAccount:
      "Your account: rank {rank}, top {percent} percent, {renown} Renown",
  ...
  territoryMap: {
    title: "War Map",
    loading: "Loading the war map…",
    summary: "Season {season} war map. {owned} of {total} cells are claimed.",
    toWar: "War map",
    toWorld: "World map",
    toggleAria: "Switch between the zone, world, and war maps",
    ...
    siegeMap: "War map: {biome}",
    siegeBiomeTemperate: "Vale",
    siegeBiomeRocky: "Rock",
    siegeBiomeSnow: "Snow",
    siegeBiomeDesert: "Dune",
    noGuild: "Join a guild to claim territory.",
    capacity: "{owned} / {capacity} hexes",
    resources: "Wood {wood} · Iron {iron} · Grain {grain} · Labor {labor}",
    resourcesReady:
      "Ready: Wood {wood} · Iron {iron} · Grain {grain} · Labor {labor}",
    resourcesInBags:
      "Bags: Wood {wood} · Iron {iron} · Grain {grain} · Labor {labor}",
    productionTitle: "Hourly territory production",
    productionRate: "+{amount}/h",
    placeKeep: "Place keep",
    claim: "Capture hex",
    captureTitle: "Neutral Camp",
    captureTierTitle: "Neutral Camp · Tier {tier} · Level {level}",
    capturePreparing: "Expedition begins in {seconds}s",
    captureRespawn: "Respawning at the staging point in {seconds}s",
    captureAvailable: "Guild camp battle active · Closes in {seconds}s",
    captureRegistered: "Registered · Encounter closes in {seconds}s",
    captureSafeStaging: "Preparing a safe transfer beyond enemy aggro range.",
    captureJoin: "Join camp battle",
    captureEnter: "Enter camp battle",
    captureLeave: "Leave camp battle",
    captureRoster: "Raid · {registered} registered · {inside} inside",
    captureMember: "{name} — {status}",
    captureMemberOffline: "Offline",
    captureMemberRespawning: "Respawning",
    captureMemberPreparing: "Preparing",
    captureMemberInside: "Inside",
    captureMemberRegistered: "Registered",
    captureGuards: "Camp guards: {count}",
    captureHold: "Hold camp: {seconds}s",
    captureLocked: "Defeat every guard to begin capture.",
    captureWave: "Inside: {occupants} · Reinforcements: {count}",
    declareWar: "Declare war",
    joinWar: "Join siege",
    leaveWar: "Leave siege",
    noticeShow: "Show",
    noticeHide: "Hide",
    ...
    slotTowers: "Towers",
    slotGranary: "Granary",
    slotForester: "Forester",
    slotMine: "Mine",
    slotHouse: "House",
    slotStockpile: "Stockpile",
    slotGate: "Gate",
    slotWall: "Walls",
    slotTowerNorth: "North tower",
    slotTowerSouth: "South tower",
    slotStorehouse: "Storehouse",
    slotConstructionWorkshop: "Builder workshop",
    slotSiegeWorkshop: "Siege workshop",
    stockpileTitle: "City stockpile",
    stockpileHint:
      "Production accumulates here. Guild leaders and officers can withdraw it into their bags.",
    stockpileCapacity:
      "Capacity: {city} per resource in this city · {total} guild total",
    stockpileResource: "Resource",
    stockpileAvailable: "{resource} ready: {amount}",
    stockpileStored: "Stockpile",
    stockpileBags: "Bags",
    stockpileTotal: "Total",
    stockpileHourly: "Per hour",
    stockpileResourceSummary: "{resource}: {stored} in stockpile",
    ...
    workshopTitle: "Siege weapon production",
    workshopHint:
      "Requires an active siege workshop. Costs are paid by the guild and your purse.",
    workshopCraft: "Craft",
    workshopUpgrade: "Upgrade workshop to level {level}",
    workshopNeedsCastle: "Requires castle level {level}",
    workshopMax: "Workshop · Level 3 · Max",
    workshopLevel: "Workshop · Level {level}",
    craftRam: "Build battering ram",
    craftRamDescription:
      "A one-operator siege cart built to break castle gates.",
    craftMortar: "Build field mortar",
    craftMortarDescription:
      "An indirect-fire weapon for damaging and controlling enemy players.",
    craftCatapult: "Build field catapult",
    craftCatapultDescription:
      "A heavy launcher that damages players, gates, walls, and defense towers.",
    ...
    slotMax: "Level {level} · Max",
    resourceWood: "Wood",
    resourceIron: "Iron",
    resourceGrain: "Grain",
    resourceLabor: "Labor",
    warDeclared: "Territory war declared",
    warStarting: "War starting",
    warOngoing: "War in progress",
    warStartingCountdown: "War starts in {time}",
    warOngoingCountdown: "War ends in {time}",
    warTitle: "{attacker} attacks {defender}",
    warQueue: "Queue · {attackers} attackers · {defenders} defenders",
    warStartsAt: "Starts {time}",
    warStartsIn: "Starts in {seconds}s",
    warTeleport: "Automatic teleport in {seconds}s",
    warTeleportNote: "Stay queued for automatic teleport.",
    siegeTitle: "Territory Siege · {attackers} vs {defenders}",
    siegeTimer: "{seconds}s remaining",
    siegeRespawn: "Respawning in {seconds}s",
    ...
    leaveRam: "Leave ram",
    ramGate: "Ram gate",
    ramInteractUse: "Use battering ram",
    ramInteractExit: "Exit battering ram",
    ramStrike: "Ram Strike",
    ramPowerStrike: "Empowered Ram Strike",
    ramStock: "Ram items {count} · Deployed {deployed}/{max}",
    ramUnavailable:
      "Battering rams can only be used by attackers during an active siege while the gate still stands.",
    ramPlacement:
      "Move into the marked deployment area near the castle gate before using the Battering Ram.",
    ramLimit: "This gate already has the maximum of three battering rams.",
    mortarInteractUse: "Use field mortar",
    mortarInteractExit: "Exit field mortar",
    mortarFire: "Mortar Shell",
    mortarFrost: "Chilling Shell",
    mortarVenom: "Venom Stun Shell",
    mortarUnavailable:
      "Field mortars can only be deployed during an active siege.",
    mortarPlacement:
      "The Field Mortar needs clear ground away from walls and other siege weapons.",
    mortarLimit: "Your side already has the maximum of three field mortars.",
    catapultInteractUse: "Use field catapult",
    catapultInteractExit: "Exit field catapult",
    defenderGateEnter: "Enter keep through castle gate",
    defenderGateExit: "Leave keep through castle gate",
    catapultFire: "Heavy Boulder",
    catapultCluster: "Scattering Stones",
    catapultUnavailable:
      "Field catapults can only be deployed during an active siege.",
    catapultPlacement:
      "The Field Catapult needs clear ground away from other siege weapons.",
    catapultLimit:
      "Your side already has the maximum of three field catapults.",
    gateName: "Castle Gate",
    wallName: "Castle Wall",
    towerName: "Defense Tower",
    ramName: "Battering Ram",
    mortarName: "Field Mortar",
    catapultName: "Field Catapult",
    coreLaserStart: "Activate core laser beam",
    coreLaserStop: "Deactivate core laser beam",
  ...
  guildTerritory: {
    ...
    cancel: "Withdraw war",
    cancelPrompt:
      "Withdraw this war declaration? This is possible only before the battle begins.",
  ...
  walletBridge: {
    ...
    timeout:
      "Your wallet did not respond in time. Open the wallet and try again.",
    notConnected: "Connect and verify a wallet, then try again.",
    unsupported:
      "This wallet cannot complete that action. Connect a different wallet.",
    unavailable:
      "No wallet connection is available here. Reconnect your wallet and try again.",
  ...
  wocMarket: {
    ...
    walletLinkedConnected:
      "Your linked wallet app is connected and ready for $WOC purchases.",
    ...
    // live one.
    rateNotePaused:
      "Last known rate: about {tokens} $WOC per $1.00 USD as of {time}.",
    ...
    reserveMetTip:
      "The seller set a hidden minimum price, and the current bid meets it.",
    reserveNotMetTip:
    ...
    bidBondSchedule:
      "The bond is {rate} percent of your bid, at least {min} and at most {max}.",
    // The bond payment window off /status: an unpaid bond lapses the bid.
    bidBondPayWindow:
      "Pay the bond within {duration} of placing your bid, or the bid lapses.",
    ...
    quoteFixedNote:
      "This quote fixes the $WOC amount until it expires. A new quote may differ.",
    settlementDeadlineNote:
      "If you win, payment is due within {duration} of the auction closing.",
    ...
    // server code set).
    claimCooldownRetry:
      "You recently walked away from a Buy Now. Try again in {duration}.",
    ...
    signFailed:
      "Your wallet did not complete the payment. Check the wallet and try again.",
    ...
    signFailedConfirm:
      "Your wallet did not sign the confirmation. Check the wallet and try again.",
    ...
    sellLockedHidden:
      "Locked items are not listed here. Unlock them in your bags to sell them.",
    ...
    sellBuyNowAboveStart:
      "The buy-now price must be higher than the starting bid.",
    sellFormat: "Format",
    ...
    sellBuyNowNote:
      "Required. A buy-now listing sells at this price with no bidding.",
    ...
    settlementFailSuperseded:
      "This payment attempt was replaced by a newer one.",
    ...
    paymentPendingGeneric:
      "Your payment is submitted and awaiting confirmation.",
    ...
    bondSeenAwaitingFinality:
      "Bond payment seen on the ledger. Waiting for final confirmation.",
    bondNotYetVisible:
    ...
    bondPendingGeneric:
      "Your bond payment is submitted and awaiting confirmation.",
