...
export const hudChromeStrings = {
  ...
  territoryMap: {
    ...
    resourcesReady: 'Ready: Wood {wood} · Iron {iron} · Grain {grain} · Labor {labor}',
    resourcesInBags: 'Bags: Wood {wood} · Iron {iron} · Grain {grain} · Labor {labor}',
    ...
    stockpileCapacity: 'Capacity: {city} per resource in this city · {total} guild total',
    ...
    workshopHint: 'Requires an active siege workshop. Costs are paid by the guild and your purse.',
    workshopCraft: 'Craft',
    ...
    craftRamDescription: 'A one-operator siege cart built to break castle gates.',
    craftMortar: 'Build field mortar',
    craftMortarDescription: 'An indirect-fire weapon for damaging and controlling enemy players.',
    ...
    mortarUnavailable: 'Field mortars can only be deployed during an active siege.',
    mortarPlacement: 'The Field Mortar needs clear ground away from walls and other siege weapons.',
    ...
    catapultUnavailable: 'Field catapults can only be deployed during an active siege.',
    catapultPlacement: 'The Field Catapult needs clear ground away from other siege weapons.',
    catapultLimit: 'Your side already has the maximum of three field catapults.',
