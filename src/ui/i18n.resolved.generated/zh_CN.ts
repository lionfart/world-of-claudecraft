...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "territoryMap": {
      "title": "战争地图",
      "loading": "正在加载战争地图…",
      "summary": "第 {season} 赛季战争地图。{total} 个地块中已有 {owned} 个被占领。",
      "toWar": "战争地图",
      "toWorld": "世界地图",
      "toggleAria": "在区域、世界和战争地图之间切换",
      "selectCell": "选择一个六角格以查看详情。",
      "cell": "六角格 {cell}",
      "neutral": "中立领地",
      ...
      "noGuild": "加入公会后才能占领领地。",
      "capacity": "{owned} / {capacity} 个六角格",
      "resources": "木材 {wood} · 铁矿 {iron} · 粮食 {grain} · 劳力 {labor}",
      "placeKeep": "建造主堡",
      "claim": "占领地块",
      "declareWar": "宣战",
      "joinWar": "加入攻城战",
      ...
      "slotTowerSouth": "南塔",
      "slotStorehouse": "仓库",
      "slotConstructionWorkshop": "建造工坊",
      "slotSiegeWorkshop": "攻城工坊",
      ...
      "slotUnavailable": "请选择你的要塞",
      "slotEmpty": "空槽 · 建造",
      "slotBuilding": "建造中 · {level}级",
      "slotLevel": "{level}级 · 升级",
      "slotLevelReadOnly": "{level}级",
      "slotMax": "5级 · 已满",
      "resourceWood": "木材",
      "resourceIron": "铁矿",
      "resourceGrain": "粮食",
      ...
      "warTitle": "{attacker}进攻{defender}",
      "warQueue": "排队 · 进攻方{attackers}人 · 防守方{defenders}人",
      "warStartsAt": "{time}开始",
      "warStartsIn": "{seconds}秒后开始",
      "warTeleport": "{seconds}秒后自动传送",
      "warTeleportNote": "保持排队即可自动传送。",
      "siegeTitle": "领地攻城战 · {attackers} 对 {defenders}",
      "siegeTimer": "剩余 {seconds} 秒",
      "siegeRespawn": "{seconds} 秒后复活",
