...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.options.doubleTapDodge': '雙擊閃避',
  'hudChrome.territoryMap.title': '戰爭地圖',
  'hudChrome.territoryMap.loading': '正在載入戰爭地圖…',
  'hudChrome.territoryMap.summary':
    '第 {season} 賽季戰爭地圖。{total} 個地塊中已有 {owned} 個被佔領。',
  'hudChrome.territoryMap.toWar': '戰爭地圖',
  'hudChrome.territoryMap.toWorld': '世界地圖',
  'hudChrome.territoryMap.toggleAria': '在區域、世界與戰爭地圖之間切換',
  'hudChrome.territoryMap.selectCell': '選擇一個六角格以查看詳情。',
  'hudChrome.territoryMap.cell': '六角格 {cell}',
  'hudChrome.territoryMap.neutral': '中立領地',
  'hudChrome.territoryMap.owner': '由 {guild} 佔領',
  'hudChrome.territoryMap.resource': '資源：{resource}',
  'hudChrome.territoryMap.noResource': '無資源礦床',
  'hudChrome.territoryMap.noGuild': '加入公會後才能佔領領地。',
  'hudChrome.territoryMap.capacity': '{owned} / {capacity} 個六角格',
  'hudChrome.territoryMap.resources':
    '木材 {wood} · 鐵礦 {iron} · 糧食 {grain} · 勞力 {labor}',
  'hudChrome.territoryMap.placeKeep': '建造主堡',
  'hudChrome.territoryMap.claim': '佔領地塊',
  'hudChrome.territoryMap.declareWar': '宣戰',
  'hudChrome.territoryMap.joinWar': '加入攻城戰',
  'hudChrome.territoryMap.leaveWar': '離開攻城戰',
  'hudChrome.territoryMap.build': '建造下一設施',
  'hudChrome.territoryMap.upgrade': '升級建築',
  'hudChrome.territoryMap.resourceWood': '木材',
  'hudChrome.territoryMap.resourceIron': '鐵礦',
  'hudChrome.territoryMap.resourceGrain': '糧食',
  'hudChrome.territoryMap.resourceLabor': '勞力',
  'hudChrome.territoryMap.siegeTitle': '領地攻城戰 · {attackers} 對 {defenders}',
  'hudChrome.territoryMap.siegeTimer': '剩餘 {seconds} 秒',
  'hudChrome.territoryMap.siegeRespawn': '{seconds} 秒後復活',
  ...
  'hudChrome.territoryMap.structureSlots': '要塞建築',
  'hudChrome.territoryMap.slotKeep': '要塞核心',
  'hudChrome.territoryMap.slotGate': '城門',
  'hudChrome.territoryMap.slotWall': '城牆',
  ...
  'hudChrome.territoryMap.slotUnavailable': '請選擇你的要塞',
  'hudChrome.territoryMap.slotEmpty': '空槽 · 建造',
  'hudChrome.territoryMap.slotBuilding': '建造中 · {level}級',
  'hudChrome.territoryMap.slotLevel': '{level}級 · 升級',
  'hudChrome.territoryMap.slotLevelReadOnly': '{level}級',
  'hudChrome.territoryMap.slotMax': '5級 · 已滿',
  'hudChrome.territoryMap.warDeclared': '領地戰爭已宣戰',
  'hudChrome.territoryMap.warTitle': '{attacker}進攻{defender}',
  'hudChrome.territoryMap.warQueue': '排隊 · 進攻方{attackers}人 · 防守方{defenders}人',
  'hudChrome.territoryMap.warStartsAt': '{time}開始',
  'hudChrome.territoryMap.warStartsIn': '{seconds}秒後開始',
  'hudChrome.territoryMap.warTeleport': '{seconds}秒後自動傳送',
  'hudChrome.territoryMap.warTeleportNote': '保持排隊即可自動傳送。',
};
