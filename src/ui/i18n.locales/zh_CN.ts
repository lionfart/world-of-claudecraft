...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.options.doubleTapDodge': '双击闪避',
  'hudChrome.territoryMap.title': '战争地图',
  'hudChrome.territoryMap.loading': '正在加载战争地图…',
  'hudChrome.territoryMap.summary':
    '第 {season} 赛季战争地图。{total} 个地块中已有 {owned} 个被占领。',
  'hudChrome.territoryMap.toWar': '战争地图',
  'hudChrome.territoryMap.toWorld': '世界地图',
  'hudChrome.territoryMap.toggleAria': '在区域、世界和战争地图之间切换',
  'hudChrome.territoryMap.selectCell': '选择一个六角格以查看详情。',
  'hudChrome.territoryMap.cell': '六角格 {cell}',
  'hudChrome.territoryMap.neutral': '中立领地',
  'hudChrome.territoryMap.owner': '由 {guild} 占领',
  'hudChrome.territoryMap.resource': '资源：{resource}',
  'hudChrome.territoryMap.noResource': '无资源矿床',
  'hudChrome.territoryMap.noGuild': '加入公会后才能占领领地。',
  'hudChrome.territoryMap.capacity': '{owned} / {capacity} 个六角格',
  'hudChrome.territoryMap.resources':
    '木材 {wood} · 铁矿 {iron} · 粮食 {grain} · 劳力 {labor}',
  'hudChrome.territoryMap.placeKeep': '建造主堡',
  'hudChrome.territoryMap.claim': '占领地块',
  'hudChrome.territoryMap.declareWar': '宣战',
  'hudChrome.territoryMap.joinWar': '加入攻城战',
  'hudChrome.territoryMap.leaveWar': '离开攻城战',
  'hudChrome.territoryMap.build': '建造下一设施',
  'hudChrome.territoryMap.upgrade': '升级建筑',
  'hudChrome.territoryMap.resourceWood': '木材',
  'hudChrome.territoryMap.resourceIron': '铁矿',
  'hudChrome.territoryMap.resourceGrain': '粮食',
  'hudChrome.territoryMap.resourceLabor': '劳力',
  'hudChrome.territoryMap.siegeTitle': '领地攻城战 · {attackers} 对 {defenders}',
  'hudChrome.territoryMap.siegeTimer': '剩余 {seconds} 秒',
  'hudChrome.territoryMap.siegeRespawn': '{seconds} 秒后复活',
  'hudChrome.territoryMap.siegeGate': '城门 {percent}%',
  'hudChrome.territoryMap.siegeCore': '主堡核心 {percent}%',
  'hudChrome.territoryMap.deployRam': '部署攻城锤',
  'hudChrome.territoryMap.ramGate': '用攻城锤攻击城门',
  'hudChrome.territoryMap.deployRamp': '部署攻城坡道',
  'hudChrome.territoryMap.strikeCore': '攻击主堡核心',
  ...
  'hudChrome.territoryMap.structureSlots': '要塞建筑',
  'hudChrome.territoryMap.slotKeep': '要塞核心',
  'hudChrome.territoryMap.slotGate': '城门',
  'hudChrome.territoryMap.slotWall': '城墙',
  'hudChrome.territoryMap.slotTowerNorth': '北塔',
  'hudChrome.territoryMap.slotTowerSouth': '南塔',
  'hudChrome.territoryMap.slotStorehouse': '仓库',
  'hudChrome.territoryMap.slotConstructionWorkshop': '建造工坊',
  'hudChrome.territoryMap.slotSiegeWorkshop': '攻城工坊',
  'hudChrome.territoryMap.slotUnavailable': '请选择你的要塞',
  'hudChrome.territoryMap.slotEmpty': '空槽 · 建造',
  'hudChrome.territoryMap.slotBuilding': '建造中 · {level}级',
  'hudChrome.territoryMap.slotLevel': '{level}级 · 升级',
  'hudChrome.territoryMap.slotLevelReadOnly': '{level}级',
  'hudChrome.territoryMap.slotMax': '5级 · 已满',
  'hudChrome.territoryMap.warDeclared': '领地战争已宣战',
  'hudChrome.territoryMap.warTitle': '{attacker}进攻{defender}',
  'hudChrome.territoryMap.warQueue': '排队 · 进攻方{attackers}人 · 防守方{defenders}人',
  'hudChrome.territoryMap.warStartsAt': '{time}开始',
  'hudChrome.territoryMap.warStartsIn': '{seconds}秒后开始',
  'hudChrome.territoryMap.warTeleport': '{seconds}秒后自动传送',
  'hudChrome.territoryMap.warTeleportNote': '保持排队即可自动传送。',
};
