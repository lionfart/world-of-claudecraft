...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.options.doubleTapDodge': '더블 탭 회피',
  'hudChrome.territoryMap.title': '전쟁 지도',
  'hudChrome.territoryMap.loading': '전쟁 지도를 불러오는 중…',
  'hudChrome.territoryMap.summary':
    '시즌 {season} 전쟁 지도. 전체 {total}개 헥스 중 {owned}개가 점령되었습니다.',
  'hudChrome.territoryMap.toWar': '전쟁 지도',
  'hudChrome.territoryMap.toWorld': '세계 지도',
  'hudChrome.territoryMap.toggleAria': '지역, 세계, 전쟁 지도 간 전환',
  'hudChrome.territoryMap.selectCell': '헥스를 선택해 상세 정보를 확인하세요.',
  'hudChrome.territoryMap.cell': '헥스 {cell}',
  'hudChrome.territoryMap.neutral': '중립 영토',
  'hudChrome.territoryMap.owner': '{guild} 소유',
  'hudChrome.territoryMap.resource': '자원: {resource}',
  'hudChrome.territoryMap.noResource': '자원 매장지 없음',
  'hudChrome.territoryMap.noGuild': '영토를 점령하려면 길드에 가입하세요.',
  'hudChrome.territoryMap.capacity': '{owned} / {capacity} 헥스',
  'hudChrome.territoryMap.resources':
    '목재 {wood} · 철광 {iron} · 곡물 {grain} · 노동력 {labor}',
  'hudChrome.territoryMap.placeKeep': '본성 건설',
  'hudChrome.territoryMap.claim': '헥스 점령',
  'hudChrome.territoryMap.declareWar': '선전 포고',
  'hudChrome.territoryMap.joinWar': '공성전 참가',
  'hudChrome.territoryMap.leaveWar': '공성전 나가기',
  'hudChrome.territoryMap.build': '다음 시설 건설',
  'hudChrome.territoryMap.upgrade': '건물 강화',
  'hudChrome.territoryMap.resourceWood': '목재',
  'hudChrome.territoryMap.resourceIron': '철광',
  'hudChrome.territoryMap.resourceGrain': '곡물',
  'hudChrome.territoryMap.resourceLabor': '노동력',
  'hudChrome.territoryMap.siegeTitle': '영토 공성전 · {attackers} 대 {defenders}',
  'hudChrome.territoryMap.siegeTimer': '남은 시간 {seconds}초',
  'hudChrome.territoryMap.siegeRespawn': '{seconds}초 후 부활',
  'hudChrome.territoryMap.siegeGate': '성문 {percent}%',
  ...
  'hudChrome.territoryMap.structureSlots': '요새 건물',
  'hudChrome.territoryMap.slotKeep': '요새 핵심부',
  'hudChrome.territoryMap.slotGate': '성문',
  'hudChrome.territoryMap.slotWall': '성벽',
  'hudChrome.territoryMap.slotTowerNorth': '북쪽 탑',
  'hudChrome.territoryMap.slotTowerSouth': '남쪽 탑',
  'hudChrome.territoryMap.slotStorehouse': '창고',
  'hudChrome.territoryMap.slotConstructionWorkshop': '건설 작업장',
  'hudChrome.territoryMap.slotSiegeWorkshop': '공성 작업장',
  'hudChrome.territoryMap.slotUnavailable': '내 요새를 선택하세요',
  'hudChrome.territoryMap.slotEmpty': '빈 슬롯 · 건설',
  'hudChrome.territoryMap.slotBuilding': '건설 중 · {level}레벨',
  'hudChrome.territoryMap.slotLevel': '{level}레벨 · 강화',
  'hudChrome.territoryMap.slotLevelReadOnly': '{level}레벨',
  'hudChrome.territoryMap.slotMax': '5레벨 · 최대',
  'hudChrome.territoryMap.warDeclared': '영토 전쟁이 선포되었습니다',
  'hudChrome.territoryMap.warTitle': '{attacker}의 {defender} 공격',
  'hudChrome.territoryMap.warQueue': '대기 · 공격 {attackers}명 · 방어 {defenders}명',
  'hudChrome.territoryMap.warStartsAt': '{time} 시작',
  'hudChrome.territoryMap.warStartsIn': '{seconds}초 후 시작',
  'hudChrome.territoryMap.warTeleport': '{seconds}초 후 자동 이동',
  'hudChrome.territoryMap.warTeleportNote': '대기열을 유지하면 자동으로 이동합니다.',
};
