...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.options.doubleTapDodge': 'ダブルタップ回避',
  'hudChrome.territoryMap.title': '戦争マップ',
  'hudChrome.territoryMap.loading': '戦争マップを読み込み中…',
  'hudChrome.territoryMap.summary':
    'シーズン {season} の戦争マップ。全 {total} ヘックス中 {owned} ヘックスが占領されています。',
  'hudChrome.territoryMap.toWar': '戦争マップ',
  'hudChrome.territoryMap.toWorld': 'ワールドマップ',
  'hudChrome.territoryMap.toggleAria': 'ゾーン、ワールド、戦争マップを切り替える',
  'hudChrome.territoryMap.selectCell': 'ヘックスを選択して詳細を確認してください。',
  'hudChrome.territoryMap.cell': 'ヘックス {cell}',
  'hudChrome.territoryMap.neutral': '中立領地',
  'hudChrome.territoryMap.owner': '{guild} が領有',
  'hudChrome.territoryMap.resource': '資源：{resource}',
  'hudChrome.territoryMap.noResource': '資源鉱床なし',
  'hudChrome.territoryMap.noGuild': '領地を占領するにはギルドに参加してください。',
  'hudChrome.territoryMap.capacity': '{owned} / {capacity} ヘックス',
  'hudChrome.territoryMap.resources':
    '木材 {wood} · 鉄鉱 {iron} · 穀物 {grain} · 労働力 {labor}',
  'hudChrome.territoryMap.placeKeep': '砦を建設',
  'hudChrome.territoryMap.claim': 'ヘックスを占領',
  'hudChrome.territoryMap.declareWar': '宣戦布告',
  'hudChrome.territoryMap.joinWar': '攻城戦に参加',
  'hudChrome.territoryMap.leaveWar': '攻城戦から退出',
  'hudChrome.territoryMap.build': '次の施設を建設',
  'hudChrome.territoryMap.upgrade': '建物を強化',
  'hudChrome.territoryMap.resourceWood': '木材',
  'hudChrome.territoryMap.resourceIron': '鉄鉱',
  'hudChrome.territoryMap.resourceGrain': '穀物',
  'hudChrome.territoryMap.resourceLabor': '労働力',
  'hudChrome.territoryMap.siegeTitle': '領地攻城戦 · {attackers} 対 {defenders}',
  'hudChrome.territoryMap.siegeTimer': '残り {seconds} 秒',
  'hudChrome.territoryMap.siegeRespawn': '{seconds} 秒後に復活',
  'hudChrome.territoryMap.siegeGate': '城門 {percent}%',
  ...
  'hudChrome.territoryMap.structureSlots': '砦の建造物',
  'hudChrome.territoryMap.slotKeep': '砦の中枢',
  'hudChrome.territoryMap.slotGate': '城門',
  'hudChrome.territoryMap.slotWall': '城壁',
  'hudChrome.territoryMap.slotTowerNorth': '北の塔',
  'hudChrome.territoryMap.slotTowerSouth': '南の塔',
  'hudChrome.territoryMap.slotStorehouse': '倉庫',
  'hudChrome.territoryMap.slotConstructionWorkshop': '建築工房',
  'hudChrome.territoryMap.slotSiegeWorkshop': '攻城工房',
  'hudChrome.territoryMap.slotUnavailable': '自分の砦を選択',
  'hudChrome.territoryMap.slotEmpty': '空き · 建造',
  'hudChrome.territoryMap.slotBuilding': '建造中 · レベル{level}',
  'hudChrome.territoryMap.slotLevel': 'レベル{level} · 強化',
  'hudChrome.territoryMap.slotLevelReadOnly': 'レベル{level}',
  'hudChrome.territoryMap.slotMax': 'レベル5 · 最大',
  'hudChrome.territoryMap.warDeclared': '領土戦が宣言されました',
  'hudChrome.territoryMap.warTitle': '{attacker}が{defender}を攻撃',
  'hudChrome.territoryMap.warQueue': '待機 · 攻撃{attackers}人 · 防衛{defenders}人',
  'hudChrome.territoryMap.warStartsAt': '{time}開始',
  'hudChrome.territoryMap.warStartsIn': '開始まで{seconds}秒',
  'hudChrome.territoryMap.warTeleport': '{seconds}秒後に自動転送',
  'hudChrome.territoryMap.warTeleportNote': '待機を続けると自動で転送されます。',
};
